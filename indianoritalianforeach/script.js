...
// let arr = [];
// for (let values of data.recipes) {
//   arr.push({
//     arrName: values.cuisine,
//     arrCuisine: values.name,
//   });
// }
// for (let i = 0; i < arr.length; i++) {
//   if (arr[i].arrName === "Italian" || arr[i].arrName === "Indian")
//     document.write(`<h3>${arr[i].arrCuisine}</h3>`);
// }
data.recipes.forEach((number) => {
  number.tags.forEach((tag) => {
    if (tag === "Indian" || tag === "Italian") {
      document.write(`<h3>${number.name}</h3>`);
