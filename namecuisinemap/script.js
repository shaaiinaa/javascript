...
// let arr = data.recipes.map((recipes) => {
//   return {
//     name: recipes.name,
...
//   document.write(`<h3>${arr[i].name} : ${arr[i].cuisine}</h3>`);
// }

// data.recipes.forEach(({ name, cuisine }) => {
//   document.write(`<h3>${name} : ${cuisine}</h3>`);
// });
let count = 0;
data.recipes.map(({ name, cuisine }) => {
  count++;
  document.write(`<h3>${name} : ${cuisine}</h3>,`);
});
